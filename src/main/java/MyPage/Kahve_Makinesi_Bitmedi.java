...
public class Kahve_Makinesi_Bitmedi {
  ...
  String boyut oluşturun...
       ...
       HERKESE KOLAY GELSİN !! :)
        ...
        System.out.println("Hoşgeldiniz \n*************\nHANGİ KAHVEYİ İSTERSİNİZ\n****************\n1.Türk Kahvesi\n2.Espresso\n3.Filtre Kahve");
int kahveNumarası=input.nextInt();
String hangiKahve[]={"Türk Kahvesi","Espresso","Filtre Kahve"};

        System.out.println(hangiKahve[kahveNumarası-1]+" hazırlanıyor...");
        ...
        System.out.println("Şeker istiyor musunuz?(Evet/Hayır");
String wantSugar=input.next();
        if(wantSugar.equalsIgnoreCase("evet")){
        ...
        }else if(wantSugar.equalsIgnoreCase("hayır")){
            System.out.println("şeker eklenmiyor");
        }
        System.out.println("Boyutu nasıl olsun?(büyük/orta/küçük");
